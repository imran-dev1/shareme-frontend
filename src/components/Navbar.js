      ...
      <div className="flex gap-2 md:gap-5 w-full mt-5 pb-4">
         ...
         <div className="flex gap-2 items-center">
            <Link to={`/user-profile/${user._id}`}>
               <img src={user.image} alt="" className="w-14 rounded-full hidden md:block" />
            </Link>
            <Link to={`/create-pin`} className="bg-black w-12 h-12  md:w-14 inline-block text-white rounded-md flex justify-center items-center">
               <IoMdAdd></IoMdAdd>
            </Link>
         </div>
      </div>
